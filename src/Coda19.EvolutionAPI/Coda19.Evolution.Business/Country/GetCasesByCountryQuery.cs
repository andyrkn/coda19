...
{
    public sealed class GetCasesByCountryQuery: GetFilterModel, IRequest<IDictionary<string, string>>
    {
    ...
    internal sealed class GetCasesByCountryQueryHandler : IRequestHandler<GetCasesByCountryQuery, IDictionary<string, string>>
    {
        public async Task<IDictionary<string, string>> Handle(GetCasesByCountryQuery request, CancellationToken cancellationToken)
        {
