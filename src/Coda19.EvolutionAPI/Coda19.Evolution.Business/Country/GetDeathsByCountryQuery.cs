...
{
    public sealed class GetDeathsByCountryQuery : GetFilterModel, IRequest<IDictionary<string, string>>
    {
    ...
    internal sealed class GetDeathsByCountryQueryHandler : IRequestHandler<GetDeathsByCountryQuery, IDictionary<string, string>>
    {
        public async Task<IDictionary<string, string>> Handle(GetDeathsByCountryQuery request, CancellationToken cancellationToken)
        {
